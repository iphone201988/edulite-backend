...
export const registerSchema = {body:Joi.object({
...
export const verifyUserEmailSchema = {body:Joi.object({
    email: Joi.string().email().lowercase().trim().required(),
  ...
  export const loginUserSchema = {body:Joi.object({
    email: Joi.string()
      .email()
      .lowercase()
      .trim()
  ...
  export const updateProfileSchema = {body:Joi.object({
...
export const changePasswordSchema = {body:Joi.object({
  ...
  export const forgetPasswordSchema = {body:Joi.object({
    email: Joi.string()
